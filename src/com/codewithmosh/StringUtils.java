...
public class StringUtils {
  ...
  //edge case: empty string, white space, uppercase lowercase, null
...
//    return reversed.toString().trim();
  ...
  public static boolean areAnagrams2(String first, String second) {
    //第二种方法不加length判断防不住：abcd ，abc
    if(first == null || second == null || first.length() != second.length())
      return false;

    final int ENGLIST_ALPHABET = 26;
    int[] frequencies = new int[ENGLIST_ALPHABET];
